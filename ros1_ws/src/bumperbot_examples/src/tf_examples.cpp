...
TfExamples::TfExamples(const ros::NodeHandle &nh)
    : nh_(nh),x_increment_(0.05),last_x_(0.0),tf_listener_(tf_buffer_),rotations_counter_(0)
{
...
bool TfExamples::getTransformCallback(bumperbot_examples::GetTransform::Request &req,bumperbot_examples::GetTransform::Response &res)
{
